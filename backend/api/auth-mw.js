/**
 * backend/api/auth-mw.js
 * Middleware & helper cho xác thực JWT + băm mật khẩu.
 *
 * Token payload: { id (tai_khoan_id), profile_id (khach_hang_id | nhan_vien_id), loai: 'customer'|'admin', role, email, ho_ten }
 */
const jwt = require('jsonwebtoken');
const bcrypt = require('bcryptjs');

const JWT_SECRET = process.env.JWT_SECRET || 'vnpt_dev_secret_change_me';
...
/** Bắt buộc là admin / nhân viên quản trị. */
